...
G = [0 -1; 
     1  2];        % Matriz de estado
 H = [0.00125; 
     0.00125];       % Matriz de entrada
...
zeta = 0.7;      % coeficiente de amortiguamiento %1
Ts   = 1;      % tiempo de asentamiento deseado (2%) 2
Tm   = 0.05;    % tiempo de muestreo 0.1
...
fiG = Gep^3 - 1.7*Gep^2 +0.831*Gep -0.067*I % cambiar por lo que del POLD
